...
// src/http/controllers/gym/create-gym-controller.spec.ts
...
describe("Create Gym (e2e)", () => {
  ...
  it("should be able to create a gym", async () => {
    ...
    const response = await (0, import_supertest2.default)(app.server).post("/gyms").set("Authorization", `Bearer ${token}`).send({
